...
StrokeFrame.Position = UDim2.new(0.485, 0, 0.355, 0)
...
StrokeFrame.Parent = Main

local UIStroke16 = Instance.new("UIStroke")
UIStroke16.Name = "UIStroke"
UIStroke16.Color = Color3.new(0.8, 0, 1)
UIStroke16.Parent = StrokeFrame
...
Title.Parent = StrokeFrame

local UIGradient = Instance.new("UIGradient")
UIGradient.Name = "UIGradient"
UIGradient.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0.972549, 0.207843, 1)), ColorSequenceKeypoint.new(0.5, Color3.new(0.521569, 1, 0.521569)), ColorSequenceKeypoint.new(1, Color3.new(1, 0.913725, 0.435294))})
UIGradient.Parent = Title

local AutoEggCollectTitle = Instance.new("TextLabel")
AutoEggCollectTitle.Name = "AutoEggCollectTitle"
AutoEggCollectTitle.Position = UDim2.new(0.375, 0, 0.38, 0)
AutoEggCollectTitle.Size = UDim2.new(0.7, 0, 0.03, 0)
AutoEggCollectTitle.BackgroundColor3 = Color3.new(0.490196, 0, 0.392157)
AutoEggCollectTitle.BorderSizePixel = 0
AutoEggCollectTitle.BorderColor3 = Color3.new(0, 0, 0)
AutoEggCollectTitle.AnchorPoint = Vector2.new(0.5, 0.5)
AutoEggCollectTitle.Text = "Auto Egg Collect"
AutoEggCollectTitle.TextColor3 = Color3.new(1, 1, 1)
AutoEggCollectTitle.TextSize = 14
AutoEggCollectTitle.FontFace = Font.new("rbxasset://fonts/families/HighwayGothic.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
AutoEggCollectTitle.TextScaled = true
AutoEggCollectTitle.TextWrapped = true
AutoEggCollectTitle.Parent = Main
...
UIStroke17.Parent = AutoEggCollectTitle

local AutoEggCollectButton = Instance.new("TextButton")
AutoEggCollectButton.Name = "AutoEggCollectButton"
AutoEggCollectButton.Position = UDim2.new(0.85, 0, 0.38, 0)
AutoEggCollectButton.Size = UDim2.new(0.175, 0, 0.03, 0)
AutoEggCollectButton.BackgroundColor3 = Color3.new(1, 0, 0)
AutoEggCollectButton.BackgroundTransparency = 0.75
AutoEggCollectButton.BorderSizePixel = 0
AutoEggCollectButton.BorderColor3 = Color3.new(0, 0, 0)
AutoEggCollectButton.AnchorPoint = Vector2.new(0.5, 0.5)
AutoEggCollectButton.Transparency = 0.75
AutoEggCollectButton.Text = ""
AutoEggCollectButton.TextColor3 = Color3.new(0, 0, 0)
AutoEggCollectButton.TextSize = 14
AutoEggCollectButton.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
AutoEggCollectButton.Parent = Main

local UICorner13 = Instance.new("UICorner")
UICorner13.Name = "UICorner"
UICorner13.CornerRadius = UDim.new(1, 0)
UICorner13.Parent = AutoEggCollectButton

local UIStroke18 = Instance.new("UIStroke")
UIStroke18.Name = "UIStroke"
UIStroke18.Color = Color3.new(1, 0, 0)
UIStroke18.Thickness = 2
UIStroke18.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
UIStroke18.Parent = AutoEggCollectButton
...
Dot7.Transparency = 1
Dot7.Parent = AutoEggCollectButton
...
EggIcon.Position = UDim2.new(0.1, 0, 0.337, 0)
EggIcon.Size = UDim2.new(0.1, 0, 0.1, 0)
EggIcon.BackgroundColor3 = Color3.new(1, 1, 1)
EggIcon.BackgroundTransparency = 1
EggIcon.BorderSizePixel = 0
EggIcon.BorderColor3 = Color3.new(0, 0, 0)
EggIcon.Rotation = -10
EggIcon.AnchorPoint = Vector2.new(0.5, 0.5)
EggIcon.Transparency = 1
EggIcon.Image = "rbxassetid://98326079158002"
EggIcon.Parent = Main

local UIAspectRatioConstraint8 = Instance.new("UIAspectRatioConstraint")
UIAspectRatioConstraint8.Name = "UIAspectRatioConstraint"

UIAspectRatioConstraint8.Parent = EggIcon

local AutoEggCollectStartus = Instance.new("TextLabel")
AutoEggCollectStartus.Name = "AutoEggCollectStartus"
AutoEggCollectStartus.Position = UDim2.new(0.525, 0, 0.337, 0)
AutoEggCollectStartus.Size = UDim2.new(0.7, 0, 0.04, 0)
AutoEggCollectStartus.BackgroundColor3 = Color3.new(1, 1, 1)
AutoEggCollectStartus.BackgroundTransparency = 1
AutoEggCollectStartus.BorderSizePixel = 0
AutoEggCollectStartus.BorderColor3 = Color3.new(0, 0, 0)
AutoEggCollectStartus.AnchorPoint = Vector2.new(0.5, 0.5)
AutoEggCollectStartus.Transparency = 1
AutoEggCollectStartus.Text = "0 / 00:00"
AutoEggCollectStartus.TextColor3 = Color3.new(1, 1, 1)
AutoEggCollectStartus.TextSize = 14
AutoEggCollectStartus.FontFace = Font.new("rbxasset://fonts/families/PatrickHand.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
AutoEggCollectStartus.TextScaled = true
AutoEggCollectStartus.TextWrapped = true
AutoEggCollectStartus.TextXAlignment = Enum.TextXAlignment.Left
AutoEggCollectStartus.Parent = Main
