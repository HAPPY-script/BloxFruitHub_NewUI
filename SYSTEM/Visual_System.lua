...
-- CheckPlayers system LocalScript
-- Assumes UI located at PlayerGui > BloxFruitHubGui > Main > ScrollingTab > Visual
-- Visual contains folder "UIPlayers" with "PlayerFrame" (ScrollingFrame) which contains "Player1" template
-- Visual also contains "CheckPlayersButton" to toggle
